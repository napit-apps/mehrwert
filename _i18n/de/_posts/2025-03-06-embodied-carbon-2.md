...
In addition to the extraction of raw materials and production, global transportation also contributes significantly to the carbon footprint of the IT industry. Many components are manufactured in different countries before they are finally assembled into a finished product in final assembly plants. A laptop, for example, contains raw materials from Africa, processed in Asia and then sold in Europe or North America. These complex supply chains lead to enormous transportation emissions:
